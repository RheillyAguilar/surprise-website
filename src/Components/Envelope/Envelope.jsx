...
export default function Envelope() {
    ...
    return (
        <section className="flex flex-col justify-center items-center">
            <p className='absolute top-[25%] font-bold text-xl max-w-xl text-center'>Take Note: To improve the reading experience, you can press the play button in the navigation, and the content inside the envelope is scrollable.</p>
